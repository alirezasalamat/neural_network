# 
# Project automation script for neural_network 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source F:/CAs/CAD_CAs/neural_network/neural_network.tcl), then you can
...
set myProject "neural_network"
set myScript "F:/CAs/CAD_CAs/neural_network/neural_network.tcl"
...
proc add_source_files {} {
   ...
   xfile add "sim/tb/test_bench.v"
   xfile add "src/hdl/activation_function.v"
   xfile add "src/hdl/adder.v"
   xfile add "src/hdl/controller.v"
   xfile add "src/hdl/datapath.v"
   xfile add "src/hdl/neural_network.v"
   xfile add "src/hdl/register.v"
   xfile add "src/hdl/selection_input.v"
   xfile add "src/hdl/single_neuron.v"

   # Set the Top Module as well...
   project set top "test_bench"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "F:/CAs/CAD_CAs/neural_network/prj/ise/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "test_bench" -process "Generate IBIS Model"
